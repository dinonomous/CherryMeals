  ...
  return (
    <html lang="en">
      ...
      >
        ...
        <main className="dark:bg-blackCustom bg-whiteCustom w-screen px-10 py-10 text-gray-900 dark:text-whiteCustom relative">
          {children}
        </main>
                ...
                <div className="text-center sm:text-left">
                  ...
                  <nav className="mt-8">
                    <ul className="space-y-4 text-sm">
                      <li>
                        <a
                          className="text-black dark:text-whiteCustom transition hover:text-black dark:text-whiteCustom/75"
                          href="/"
                        >
                          Company History
                        </a>
                    ...
                    <ul className="space-y-4 text-sm">
                      ...
                      <li>
                        <a
                          ...
                          href="/"
                        >
                          <span className="text-black dark:text-whiteCustom transition group-hover:text-black dark:text-whiteCustom/75">
                            Live Chat
                          </span>
                  ...
                  <ul className="mt-8 space-y-4 text-sm">
                    <li>
                      ...
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="w-5 h-5 text-black dark:text-whiteCustom shrink-0"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                          stroke-width="2"
                    ...
                    <li className="flex items-start justify-center gap-1.5 sm:justify-start">
                      ...
                      <address className="-mt-0.5 not-italic text-black dark:text-whiteCustom">
