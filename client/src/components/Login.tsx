...
const LoginForm: React.FC = () => {
  ...
  return (
    <>
      <span className="flex min-h-[80vh] max-w-7xl mx-auto items-center">
        <div className="w-full md:w-1/2 pr-7 flex flex-col justify-center box-border h-fit">
        ...
        <div className="relative w-1/2 hidden md:block h-[700px]">
          {loadingImage && (
            <div
              role="status"
